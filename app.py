...
#SQLITE kept incase we want to test locally, added as second argument
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///data.db') #can use mysql postgresql etc and they will work
